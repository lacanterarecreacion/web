              ...
              >
                <Dialog.Panel className="w-full max-w-sm overflow-hidden text-left align-middle transition-all transform bg-white shadow-xl rounded-2xl">
                  <div className="w-full pt-3 overflow-hidden relative flex justify-center items-start  h-64 bg-emerald-600">
                    ...
                    <Dialog.Title
                      as="h3"
                      className=" z-10 h-24 text-white absolute bottom-0 left-0 right-0 bg-gradient-to-b from-transparent via-50% via-teal-900/80 to-teal-900/90 text-3xl flex justify-center items-end font-medium leading-6 text-center"
                    >
                      <span className="font-mono mb-6">Entérate</span>
                    </Dialog.Title>
                    <div className="absolute inset-0 patternForest opacity-20 z-"></div>
                  </div>
                  <div className="mt-6 text-center px-6">
                    <p className="text-base font-mono text-gray-500">
                      Sumate a nuestro grupo de WP en donde compartimos nuestro
                      newsletter.
                    </p>
                  </div>
