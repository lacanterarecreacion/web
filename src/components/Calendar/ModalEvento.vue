        ...
        >
          ...
          >
            ...
            >
              ...
              <DialogTitle
                as="h3"
                class="text-2xl p-3 font-medium leading-6 text-gray-900"
              >
                <slot name="header" />
              </DialogTitle>
              <div class="px-3">
              ...
              <div class="mt-4 flex justify-center items-center p-3 gap-6">
                <button type="button" class="btn ghost w-44" @click="closeModal">
                  Cerrar
                </button>
                <slot name="link" />
              </div>
