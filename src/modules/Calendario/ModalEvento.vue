<template>
  <div class="flex justify-start items-center">
    <button v-if="props.inCalendar" type="button" @click="openModal" class="absolute inset-0">
    ...
    <button v-else type="button" @click="openModal"
      ...
      <h3 class="flex items-center w-full justify-between text-gray-600">
        ...
        <b class="!text-xs font-bold no-underline rounded-full px-2 py-0.5 bg-orange-200 text-orange-900 ml-1" v-else>
          Virtual
        </b>
      </h3>
            ...
            <DialogPanel
              ...
              <div class="relative">
                ...
                <div class="absolute top-1.5 right-0 m-3">
                  ...
                  <b class="!text-xs font-bold no-underline rounded-full px-2 py-0.5 bg-orange-200 text-orange-900 ml-1"
                    v-else>
                    Virtual
                  </b>
                </div>
              ...
              <div class="mt-4 flex justify-center items-center p-3 gap-2">
                <button type="button" class="btn !text-xs orange ghost w-44" @click="closeModal">
                  Cerrar
                </button>
                <a v-if="props.event.extendedProps?.link" class="btn blue !text-xs w-44" target="_blank"
